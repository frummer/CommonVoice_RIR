...
#SBATCH --error=logs/logs_dataset_validation/logs_dataset_validate_content/check_files.err
#SBATCH --output=logs/logs_dataset_validation/logs_dataset_validate_content/check_files.out
