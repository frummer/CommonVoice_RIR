...
#SBATCH --job-name=create-train-en-commonvoice-separation-dataset #job name
#SBATCH --nodes=1  #number of nodes requested
#SBATCH --partition=cpu  #queue
#SBATCH --cpus-per-task=4   # Request 4 CPU cores
#SBATCH --mem=32G           # Request 32GB of RAM
#SBATCH --error=/home/afrumme1/CommonVoice_RIR/logs/logs_ldc/logs_ldc_dataset/train/extract.err
#SBATCH --output=/home/afrumme1/CommonVoice_RIR/logs/logs_ldc/logs_ldc_dataset/train/extract.out
...
CONFIG_PATH=/home/afrumme1/CommonVoice_RIR/src_ldc/configs/create_ldc_overlapped_train_set_config.json
